    ...
    <div class="max-w-md mx-auto mt-10 bg-white p-6 rounded-lg shadow">
        ...
        @if($restaurant)
            <div class="space-y-4">
                ...
                <div class="border-b pb-4">
                    <h2 class="text-sm font-medium text-gray-500">Founder Id</h2>
                    <p class="mt-1 text-lg text-gray-900">{{ $restaurant->founder_id }}</p>
                </div>
                ...
                <div class="border-b pb-4">
                    <h2 class="text-sm font-medium text-gray-500">Founded At</h2>
                    <p class="mt-1 text-lg text-gray-900">{{ $restaurant->founded_at }}</p>
                </div>
